...
<html>
  ...
  <body style="text-align:center;">
    ...
    <div style="float:right;">
	    ...
	    <c:if test="${user!=null }">
	    	欢迎您：<a href="${pageContext.request.contextPath }/client/UpdateInfoServletUI?userid=${user.id}">${user.username }</a>&nbsp;&nbsp;&nbsp; <a href="${pageContext.request.contextPath }/client/LoginOutServlet">注销</a>
	    </c:if>
    </div>
  </body>
</html>
